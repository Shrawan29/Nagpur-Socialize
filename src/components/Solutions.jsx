        ...
        {solutions.map((s, i) => {
          ...
          return (
            <div
              ...
              className={`group relative cursor-pointer overflow-hidden rounded-[1.25rem] border border-white/12 bg-pill outline-none max-lg:sticky max-lg:z-30 lg:shadow-2xl lg:shadow-black/40 lg:grow lg:basis-0 lg:rounded-[2rem] lg:transition-[flex-grow] lg:duration-[800ms] lg:ease-[cubic-bezier(0.22,1,0.36,1)] lg:focus-visible:ring-2 lg:focus-visible:ring-accent ${
                open ? "lg:grow-[6]" : ""
