...
export default function Solutions() {
  ...
  return (
    ...
    >
      ...
      <Reveal className="mb-5 max-lg:sticky max-lg:top-0 max-lg:z-20 max-lg:ml-[calc(50%_-_50vw)] max-lg:w-screen max-lg:border-b max-lg:border-white/10 max-lg:bg-ink/80 max-lg:px-5 max-lg:pb-4 max-lg:pt-3 max-lg:shadow-lg max-lg:shadow-black/5 max-lg:backdrop-blur-xl sm:mb-6 sm:max-lg:px-8 lg:max-w-2xl">
